...
def parse_args():
    ...
    parser.add_argument("--predictions_dir", type=str,
                        help="Directory to find prediction data in (default: poem_sentiment_data_flant5_predictions)")
    parser.add_argument("--predictions_file", type=str,
                        help="Filename of prediction data (default: predictions_flant5_zero-shot.csv)")
...
def evaluate(predictions_file, true_labels_file, output_dir, setting, model):
    ...
    save_errors(df_true, df_pred, output_dir, setting, model)
    return f1
...
def main():
    ...
    if args.predictions_dir is None:
        args.predictions_dir = "poem_sentiment_data_flant5_predictions"
    if args.predictions_file is None:
        args.predictions_file = "predictions_flant5_zero-shot.csv"
    if args.true_labels_dir is None:
        args.true_labels_dir = "poem_sentiment"
    ...
    f1 = evaluate(predictions_file, true_labels_file, args.output_dir, args.setting, args.model)
